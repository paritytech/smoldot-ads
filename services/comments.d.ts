...
export declare const useComment: (adIdx: number, commentIdx: number) => Comment | null, comment$: (adIdx: number, commentIdx: number) => import("rxjs").Observable<Comment | null>;
